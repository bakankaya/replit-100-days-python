# Elif statement - if the condition is false, then it will execute the next line of code.
# "and" - if both conditions are true, then it will execute the next line of code.
#
#
